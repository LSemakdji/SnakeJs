window.onload = function () {
    ...
    function gameOver() {
        ...
        ctx.fillText("GameOver", centreX, centreY);
        ctx.fillText("Appuyer sur la touche ESPACE pur relancer une partie!", centreX, centreY + 10);
        ctx.restore();
    }
    function restart() {
        snakee = new Snake([[6, 4], [5, 4], [4, 4]], "right");
    ...
    function Apple(position) {
        ...
        this.draw = function () {
            ...
            ctx.beginPath();
            var radius = blockSize / 2; //rayon du cercle(pomme)
